...
##BEGIN TIME ALIGNMENT/FIND TAKEOFF AND LANDING CODE
...
##END TIME ALIGNMENT CODE AND BEING RANGE ALIGNMENT AS WELL AS OTHER SMALL FUNCTIONS TO FIX DATA
...
##CROP FUNCTION THAT MAY OR MAY NOT WORK
